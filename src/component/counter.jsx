...
function App() {
  ...
  return (
    <>
      ...
      <h2>Counter : {Numb}</h2>
      <hr className="m-5" />
      <button onClick={remove} className="bg-blue ml-7 p-6 font-bold font-serif">Remove</button>
      {/* <hr /> */}
      <button onClick={reset} className="bg-blue ml-7 p-6 font-bold  font-serif">Reset</button>
      {/* <hr /> */}
      <button onClick={add} className="bg-blue ml-7 p-6 font-bold  font-serif">Add</button>
